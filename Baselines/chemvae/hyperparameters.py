...
def load_params(param_file=None, verbose=True):
    ...
    parameters = {
        ...
        'loss': 'mean_squared_error', # set reconstruction loss     # categorical_crossentropy

        # convolution parameters
        'batchnorm_conv': True,
        'conv_activation': 'tanh',
        'conv_depth': 4,
        'conv_dim_depth': 8,    # 4 if using ElectronSphere problem, 8 otherwise
        'conv_dim_width': 8,    # 4 if using ElectronSphere problem, 8 otherwise
